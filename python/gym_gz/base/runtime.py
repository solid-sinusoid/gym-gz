...
class Runtime(gym.Env, abc.ABC):
    """
    Base class for defining executors of :py:class:`~gym_gz.base.task.Task` objects.

    :py:class:`~gym_gz.base.task.Task` classes are supposed to be generic and are
    ...
    :py:class:`~gym_gz.base.task.Task` class on different simulators or in a
    real-time setting.
    ...
    Args:
        task: the :py:class:`~gym_gz.base.task.Task` object to handle.
    ...
    Example:
        ...
        :py:class:`~gym_gz.base.task.Task` could be integrated:
    ...
    Note:
        Runtimes can handle only one :py:class:`~gym_gz.base.task.Task` object.
    """
