...
class Task(abc.ABC):
    ...
    :py:class:`~gym_gz.base.runtime.Runtime` instances are the real objects returned
    ...
    The :py:class:`~gym_gz.base.runtime.Runtime` is a relay class that calls the
    ...
    - Independent from the selected :py:class:`~gym_gz.base.runtime.Runtime`.
    ...
    def is_truncated(self) -> bool:
        ...
        This method contains the logic for defining when the environment has truncated.
        Subsequent calls to :py:meth:`Task.set_action` should be preceded by a task
        reset through :py:meth:`Task.reset_task`.
